...
ELISA Pilot Dilution Planner performs its calculations in the browser. The public beta has no account system, analytics, advertising, backend, database, cookies, or network request made by the application code.
