...
- Stage: local prototype v0.1; automated and bounded browser checks are required before Yao real-device QA.
...
- Next safe step after local checks: Yao opens the self-contained artifact on iPhone and desktop and runs the short checklist in `docs/YAO_QA.md`. No deployment is needed for this gate.
