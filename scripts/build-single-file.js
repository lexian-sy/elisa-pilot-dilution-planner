...
const googleVerificationSourcePath = path.join(root, "google15c6b5cc59503001.html");
const googleVerificationOutputPath = path.join(distPath, "google15c6b5cc59503001.html");
...
fs.copyFileSync(googleVerificationSourcePath, googleVerificationOutputPath);
process.stdout.write(`${offlineOutputPath}\n${rootOutputPath}\n${chineseOutputPath}\n${englishGuideOutputPath}\n${chineseGuideOutputPath}\n${robotsOutputPath}\n${sitemapOutputPath}\n${googleVerificationOutputPath}\n`);
